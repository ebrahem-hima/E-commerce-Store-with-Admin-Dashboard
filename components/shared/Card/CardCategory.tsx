...
const CardCategory = ({ icon: Icon, text, value, type }: Props) => {
  return (
    <Link
      ...
      className="snap-start group cursor-pointer flex-center flex-col gap-1 border border-[rgba(0,0,0,0.3)] rounded-[4px] h-[130px] hover:bg-primary hover:border-primary duration-300"
    >
      <span>
